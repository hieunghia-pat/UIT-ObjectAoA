...
def get_bbox_relative_coords(params):
    ...
    coco_ids_to_paths={str(img['id']):os.path.join(img_dir,img['filepath'],img['filename']) for img in coco_dict['images'] }
...
if __name__ == "__main__":
    ...
    parser.add_argument('--input_json', type=str, default='data/dataset_viecap4h.json', help='input json file to process into hdf5')
    parser.add_argument('--image_root', type=str, default='/home/nguyennghia/Projects/VietCap4H',
                    help='In case the image paths have to be preprended with a root path to an image folder')
    parser.add_argument('--input_box_dir', type=str, default='data/viecap4hbu_box',
                    help='path to the directory containing the boxes of att feats')
    parser.add_argument('--output_dir', type=str, default='data/viecap4hbu_box_relative',
